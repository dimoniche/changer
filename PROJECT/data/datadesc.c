...
/*************************************
  Тип вывода монеты-жетоны
*************************************/
CPU_INT08U const HopperIsCoinName[] = "Надпись выд.";
...
TDataDescStruct const HopperIsCoinDesc = {
  ...
  NULL,                     // функция по изменению
  0,       // смещение между элементами в массиве
  HopperIsCoinName,         // указатель на строку названия параметра
  DATA_IS_INDEX,            // признак индексного параметра (список строк)
  HopperIsCoinList,         // указатель на список строк для индексного параметра
  DATA_INIT_DISABLE,
  0
};
