...
/*!
  ќписание структур и способа доступа к данным
...
typedef struct{
  ...
  CPU_INT08U Desc; 
    ...
    #define DATA_DESC_VIEW  1 // дл€ просмотра 
  ...
  CPU_INT08U Type; 
    ...
    #define DATA_TYPE_HOUR_MIN          7   // врем€ в минутах, отображаетс€ как „„:ћћ
    #define DATA_TYPE_TIME_SEC_H_MM     8   // счетчик в секундах, отображаетс€ как „:ћћ
    #define DATA_TYPE_TIME_SEC_M_SS     9   // счетчик в секундах, отображаетс€ как ћ:——
    #define DATA_TYPE_TIME_SEC_M        10  // счетчик в секундах, отображаетс€ как минуты
  ...
  // указатель на строку названи€ параметра
  ...
  // указатель на список строк дл€ индексного параметра
...
// структура дл€ массива всех параметров
typedef struct{
